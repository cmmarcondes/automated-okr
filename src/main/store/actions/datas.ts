...
export const getNewKrName = (KrArray: IKeyResult[], newKrName: string, index: number) => {
...
export const getNewKrCalc = (KrArray: IKeyResult[], newKrCalc: string, index: number) => {
...
export const getNewKrInformation = (KrArray: IKeyResult[], newKrInformation: string, index: number) => {
...
export const getNewKrAtt = (KrArray: IKeyResult[], newKrAtt: string, index: number) => {
...
export const getNewKrTarget = (KrArray: IKeyResult[], newKrTarget: string, index: number) => {
